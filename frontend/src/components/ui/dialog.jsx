  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-border/60 p-6',
        className
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1.5 opacity-60 hover:opacity-100 hover:bg-muted transition-all">
        <X className="h-4 w-4" />
