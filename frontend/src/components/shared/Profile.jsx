...
import { CheckCircle2, Edit3, Save, X, Briefcase, Mail, Shield, Plus } from 'lucide-react'
...
import { SkillBadge, SkillTagInput, SkillDropdown } from '@/components/shared/SkillBadge'
...
export default function Profile() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5 page-enter">
          ...
          {!editing ? (
            <div className="space-y-2">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <Badge variant="secondary">{ROLE_MAP[user?.role] || user?.role}</Badge>
              </div>
      ...
      {/* Skills card — header + view mode UNCHANGED; edit mode swaps component */}
      <Card>
        ...
        <CardContent>
          {editing
            ? (
               ...
               * skills state + onChange signature are identical (string[]).
               * View mode (SkillBadge chips) is untouched below.
               */
